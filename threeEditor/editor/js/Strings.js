function Strings( config ) {
	...
	var values = {
		...
		zh: {
			'menubar/file': '文件',
            'menubar/file/new': '新建檔案',
            'menubar/file/import': '導入',
            'menubar/file/export/geometry': '匯出幾何體',
            'menubar/file/export/object': '匯出物體',
            ...
            'menubar/edit/clear_history': '清空歷史記錄',
            ...
            // 'menubar/add/perspectivecamera': '透視相機',
            // 'menubar/add/orthographiccamera': '正交相機',
			'menubar/add/group': 'Group',
			'menubar/add/plane': 'Plane',
			'menubar/add/box': 'Box',
			'menubar/add/circle': 'Circle',
            ...
            'menubar/view': '視圖',
            'menubar/view/fullscreen': '全畫面',

            'menubar/help': '幫助',
            'menubar/help/source_code': '原始碼',
            'menubar/help/icons': '圖示元件',
            ...
            'sidebar/settings/shortcuts/undo': '撤銷',
            ...
            'sidebar/history/persistent': '本機存放區',
